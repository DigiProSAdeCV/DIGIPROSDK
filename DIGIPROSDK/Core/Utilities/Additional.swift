...
//  DIGIPROSDK
//
//  Created by Jonathan Viloria M on 29/02/20.
...
public class Obfuscator {
    ...
    // MARK: - Initialization
    public init() { self.salt = "\(String(describing: AnyObject.self))\(String(describing: NSObject.self))" }
    
    public init(with salt: String) { self.salt = salt }
