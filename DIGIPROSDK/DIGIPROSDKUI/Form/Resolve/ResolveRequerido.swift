...
extension NuevaPlantillaViewController{
    ...
    public func resolveRequerido(_ id: String, _ mode: String, _ string: String) -> Bool {
        ...
        case "boton":
            ...
            if (mode == "asignacion"){
                if string == "true" || string.lowercased() == "si" || string.lowercased() == "1"{
                    row.cell.setRequerido(true)
                }else{
                    row.cell.setRequerido(false)
                }
                row.updateCell()
            }else if (mode == "afirmacion") {
                let vvv = row.cell.elemento.validacion.needsValidation
    ...
    func resolveRequerido(_ type: String, _ mode: String, _ rr: ReturnFormulaType, _ elem: Formula, _ formul: [Formula], _ equals: Int) -> String {
        ...
        case "boton":
            ...
            if (mode == "asignacion"){
                ...
                let vvv = String(row.cell.getRequired())
