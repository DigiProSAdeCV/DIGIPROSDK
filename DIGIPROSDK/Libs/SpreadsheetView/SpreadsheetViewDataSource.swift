...
public protocol SpreadsheetViewDataSource: class {
    ...
    func spreadsheetView(_ spreadsheetView: SpreadsheetView, cellForItemAt indexPath: IndexPath) -> CellSpread?
...
extension SpreadsheetViewDataSource {
    public func spreadsheetView(_ spreadsheetView: SpreadsheetView, cellForItemAt indexPath: IndexPath) -> CellSpread? { return nil }
