...
open class _DocumentoRowOf<T: Equatable>: Row<DocumentoCell>, KeyboardReturnHandler {
    ...
    required public init(tag: String?) {
        ...
        cellProvider = CellProvider<DocumentoCell>(nibName: "iwUpUkgDJLRqOzY", bundle: Cnstnt.Path.framework)
    }
...
public final class DocumentoRow: _DocumentoRowOf<String>, RowType { }
