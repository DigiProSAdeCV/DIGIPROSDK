...
@objc public class ScrollableSegmentedControl: UIControl {
     ...
     */
    @objc public func insertSegment(withTitle title: String, at index: Int, withColorNormal normal: UIColor?, withColorChanged changed:UIColor?) {
        let segment = SegmentData()
        segment.title = title
        segment.normalColor = normal
        segment.pressedColor = changed
        configureAttributedTitlesForSegment(segment)
    ...
    final private class CollectionViewController : NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
        ...
        fileprivate func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            case .textOnly:
                ...
                cell.controlStateColor = data.normalColor
                cell.controlStateChangedColor = data.pressedColor
                // MARK: - Change default color
                cell.backgroundColor = data.normalColor ?? #colorLiteral(red: 0, green: 0.6980392157, blue: 0.9490196078, alpha: 1)
                segmentCell = cell
            case .imageOnly:
            ...
            segmentCell.isSelected = segmentedControl.selectedSegmentIndex == indexPath.item ? true : segmentCell.isSelected
        ...
        fileprivate func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
            ...
            if let titleLabel = label {
                ...
                if cell.isHighlighted && data.highlightedAttributedTitle != nil {
                    ...
                    cell.backgroundColor = segmentedControl.tintColor
                } else {
    ...
    private class BaseSegmentCollectionViewCell: UICollectionViewCell {
        ...
        public var controlStateColor:UIColor?
        public var controlStateChangedColor:UIColor?
        ...
        override var isSelected: Bool {
            didSet {
                ...
                // MARK: - Change default color
                if isSelected{
                    self.backColor = controlStateChangedColor ?? #colorLiteral(red: 0.4705882353, green: 0.7568627451, blue: 0.3529411765, alpha: 1)
                }else{
                    self.backColor = controlStateColor ?? #colorLiteral(red: 0, green: 0.6980392157, blue: 0.9490196078, alpha: 1)
                }
    ...
    private class TextOnlySegmentCollectionViewCell: BaseSegmentCollectionViewCell {
        ...
        override var backColor:UIColor? {
            didSet {
                self.backgroundColor = (backColor == nil) ? BaseSegmentCollectionViewCell.defaultTextColor : backColor!
            }
        }
