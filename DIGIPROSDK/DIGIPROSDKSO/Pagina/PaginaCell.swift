...
public class PaginaCell: Cell<String>, CellType {
    ...
    public func setObject(obj: Elemento){
        elemento = obj
        atributos = obj.atributos as? Atributos_pagina
    }
    ...
    open override func setup() {
        super.setup()
        let apiObject = ObjectFormManager<PaginaCell>()
...
extension PaginaCell: ObjectFormDelegate {
...
extension PaginaCell: GetInfoRowDelegate{
