...
@optional
/**
 @brief Delegate method which will notify when a challenge video and the WebVTT file are captured.
 @param videoChallenges (NSData *) Contains the data of the video captured.
 @param file (NSData *) Contains the data of the WebVTT file.
 */
- (void)VDPhotoChallengeVideoCaptured:(NSData*)videoChallenges andFile:(NSData*)file;

/**
 @brief Delegate method to notify the repetition of the Selfie Alive process. 
 */
 ...
 */
//+ (void) addLogger:(_Nonnull id<VDLoggerProtocol>)logger withId:(NSString*)loggerId;

/**
 @brief This method is used to set a challenge for Selfie Alive
 @param challenge (NSString) Selfie Alive challenge.
 */
